    ...
    <header className="sticky top-0 z-50 w-full h-20 bg-[#141210]/95 backdrop-blur-md border-b border-amber-900/40 text-stone-200" dir="rtl">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full">
        <div className="flex items-center justify-between h-full gap-4">
          ...
          {/* منوی ناوبری دسکتاپ با آیکون برای تمامی گزینه‌ها */}
          ...
          {/* سرچ‌بار دسکتاپ + دکمه همبرگری موبایل */}
      ...
      {/* کشوی منوی موبایل */}
      {isMobileMenuOpen && (
        <div className="xl:hidden fixed inset-x-0 top-20 bg-[#141210]/98 border-b border-amber-900/40 backdrop-blur-xl shadow-2xl px-5 py-6 space-y-4 animate-in slide-in-from-top-3 duration-200">
